...
var wrongAnswer;
var rightAnswer;
var firstQuestionDivText = document.createTextNode(
...
beginButton.addEventListener("click", function (event) {
  ...
  firstQuestionDivText = document.createTextNode(
    "Commonly used data types DO NOT include:"
  );
...
function secondQuestion() {
  ...
  firstQuestionDivText.textContent =
    "The condition in an if/else statement is enclosed with a:";
...
function fourthQuestion() {
  ...
  firstQuestionDivText.textContent =
    "String values must be enclosed within **answer** when being assigned to variables.";
...
function gameOver() {
  ...
  if (username != null) {
    ...
    showHighScoresButton.classList.add("showHighScoresButton");
    var highScoresButtonText = document.createTextNode("View Highscores");
    showHighScoresButton.appendChild(highScoresButtonText);
    firstQuestionDiv.appendChild(showHighScoresButton);
    showHighScoresButton.addEventListener("click", function () {
      firstQuestionDivText.textContent = "Highscores:";
      //   var removingButton = document.getElementsByClassName(
      //     "showHighScoresButton"
      //   );
      //   removingButton.remove();
      var listofHighScores = document.createElement("ol");
